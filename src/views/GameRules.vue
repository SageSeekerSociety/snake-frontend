        ...
        <div class="tab-content">
          <div v-if="activeTab === 'rules'" class="rules-section">
            ...
            <ul>
              ...
              <li>坐标系统：以左上角的格子为(0, 0)，x轴向右递增，y轴向下递增。</li>
            </ul>
            ...
            <ul>
              ...
              <li><b>陷阱</b>：吃到后扣除 10 分，其值为<code>-2</code>。</li>
            </ul>
            ...
            <ul>
              ...
              <li><b>数量限制</b>：场上同时存在的食物总数上限与当前存活的蛇的数量正相关。达到上限后，将暂停自然生成食物。</li>
...
[可选] 上一回合存储在Memory系统中的数据
            ...
            <h3>5. 输入示例</h3>
            <p>以下是游戏后期某一刻（第217 tick）的完整输入数据示例：</p>
            <pre class="code-block">
39
17
19 16 1 4
...
1 5 13
            ...
            <p><b>数据解读：</b></p>
            <ul>
              <li><b>游戏进程</b>: 剩余 <b>39</b> tick（当前是第 256-39=217 tick）。</li>
              <li><b>物品</b>: 场上共有 <b>17</b>
                个物品，包括高分食物、增长豆、陷阱(<code>-2</code>)、一个宝箱(<code>-5</code>)和两把在地上的钥匙(<code>-3</code>)。</li>
              <li><b>蛇</b>: 场上有 <b>1</b> 条蛇。
                <ul>
                  <li><b>ID 2000000000</b>: 长度为 <b>9</b>，分数为 <b>82</b>。当前朝向左(0)，护盾可用。</li>
                </ul>
              </li>
              <li><b>宝箱与钥匙</b>: 场上有 <b>1</b> 个价值30分的宝箱，和 <b>2</b> 把都在地上的钥匙（holder_id = -1）。</li>
              <li><b>安全区</b>:
                <ul>
